...
def turn_left():
    ...
    GPIO.output(motors['Motor2']['IN1'], GPIO.LOW)
    GPIO.output(motors['Motor2']['IN2'], GPIO.HIGH)
    GPIO.output(motors['Motor3']['IN1'], GPIO.HIGH)
    GPIO.output(motors['Motor3']['IN2'], GPIO.LOW)
    GPIO.output(motors['Motor4']['IN1'], GPIO.HIGH)
    GPIO.output(motors['Motor4']['IN2'], GPIO.LOW)

def turn_right():
    GPIO.output(motors['Motor1']['IN1'], GPIO.HIGH)
    GPIO.output(motors['Motor1']['IN2'], GPIO.LOW)
    GPIO.output(motors['Motor2']['IN1'], GPIO.HIGH)
    GPIO.output(motors['Motor2']['IN2'], GPIO.LOW)
    GPIO.output(motors['Motor3']['IN1'], GPIO.LOW)
    GPIO.output(motors['Motor3']['IN2'], GPIO.HIGH)
